public class TryToExcapeJailStrings
{
    ...
    public string WantPlayerUseJailFreeCardTrue(int playerNumber)
    {
        return String.Format("Player{0} paid the jail fine", playerNumber);
    }

    public string WantPlayerUseJailFreeCardFalse(int playerNumber)
    {
        return String.Format("Player{0} refused to pay the jail fine", playerNumber);
    }
